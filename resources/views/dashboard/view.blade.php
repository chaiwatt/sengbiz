        ...
        <div class="row">
            ...
            <div class="col-xl-9 ps-lg-4 ps-xl-5 sidebar">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            <input type="text" name="" id="post_id" value="{{$post->id}}" hidden>
                            ...
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <select class="form-select" name="mainCategory" id="mainCategory">
                                        ...
                                        <option value="{{$mainCategory->id}}" @if ($post->main_category_id ==
                                            $mainCategory->id)
                                            selected
                                            @endif
                            ...
                            <div class="col-sm-12" id="sub_category_container">
                                <div class="">
                                    <label class="required fw-medium mb-2">หมวดหมู่รอง</label>
                                    <select class="form-select" name="subCategory" id="subCategory">
                                        <option value="{{null}}">==เลือกหมวดหมู่รอง==</option>
                                        @foreach ($post->mainCategory->subCategories as $subCategory)
                                        <option value="{{$subCategory->id}}" @if ($post->sub_category_id ==
                                            $subCategory->id)
                                            selected
                                            @endif
                            ...
                            @if ($post->mainCategory->id == 1)
                            <div class="col-sm-12" id="sub_minor_category_container">
                                <div>
                                    ...
                                    <select class="form-select" name="subMinorCategory" id="subMinorCategory">
                                        ...
                                        @foreach ($post->subCategory->subMinorCategories as $subMinorCategory)
                                        <option value="{{$subMinorCategory->id}}" @if ($post->sub_minor_category_id ==
                                            $subMinorCategory->id)
                                            selected
                                            @endif>{{$subMinorCategory->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <select class="form-select" name="province" id="province">
                                        ...
                                        <option value="{{$province->id}}" @if ($post->postInfo->province_id ==
                                            $province->id)
                                            selected
                            ...
                            <div class="col-sm-12" id="amphur_container">
                                <div class="">
                                    ...
                                    <select class="form-select" name="amphur" id="amphur">
                                        ...
                                        @foreach ($post->postInfo->province->amphurs as $amphur)
                                        <option value="{{$amphur->id}}" @if ($post->postInfo->amphur_id ==
                                            $amphur->id)
                                            selected
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" name="lat" id="lat"
                                        value="{{ old('lat') ?? $post->postInfo->lat}}">
                                </div>
                                <!-- end /. form group -->
                            </div>
                            <div class="col-sm-12">
                                ...
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" name="lng" id="lng"
                                        value="{{ old('lng') ?? $post->postInfo->lng}}">
                                </div>
                                <!-- end /. form group -->
                            </div>
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <select class="form-select" name="near_place" id="near_place">
                                        ...
                                        <option value="{{$nearPlace->name}}" @if (@$post->postNearPlace !== null)
                                            @if ($nearPlace->name == $post->postNearPlace->name)
                                            selected
                                            @endif
                                            @endif

                                            >{{$nearPlace->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" name="phone1" id="phone1"
                                        value="{{ old('phone1') ?? $post->postInfo->phone1 }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" name="phone2" id="phone2"
                                        value="{{ old('phone2') ?? $post->postInfo->phone2 }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" name="youtube" id="youtube"
                                        value="{{ old('youtube') ?? $post->postInfo->youtube }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" name="line_account" id="line_account"
                                        value="{{ old('line_account') ?? $post->postInfo->line_account }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" name="facebook" id="facebook"
                                        value="{{ old('facebook') ?? $post->postInfo->facebook }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" name="website" id="website"
                                        value="{{ old('website') ?? $post->postInfo->website }}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="">
                                    ...
                                    <select class="form-select" id="need_broker" name="need_broker" id="need_broker">
                                        <option value="1" @if (intVal($post->need_broker) === 1)
                                            selected
                                            @endif >ไม่ต้องการ</option>
                                        <option value="2" @if (intVal($post->need_broker) === 2)
                                            selected
                                            @endif>ต้องการ</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="">
                                    ...
                                    <textarea class="form-control" id="summernote" rows="10"
                                        placeholder="เขียนบทความอย่างน้อย 1,000 คำ เพื่อให้เป็นประโยชน์ต่อผู้ค้นหาใน Google และไม่จำเป็นต้องระบุข้อมูลติดต่อที่กรอกไปแล้ว (ข้อมูลติดต่อ / โซเชียลมีเดีย)">{!!$post->body!!}</textarea>
...
<script type="module" src="{{ asset('assets/js/helper/edit-post.js?v=1') }}">
</script>
<script>
    var coutFiles ;
    var uploadedImages = [];
    window.params = {
            ...
            updateRoute: '{{ route('dashboard.update') }}',
            deletePostImageRoute: '{{ route('dashboard.api.delete-post-image') }}',
            postImagesRoute: '{{ route('dashboard.api.post-images') }}',
            url: '{{ url('/') }}',
    ...
    $(document).ready(function() {
        ...
        var dropzone = new Dropzone('#image-upload', {
            ...
            init: function() {
                ...
                var postImagesUrl = window.params.postImagesRoute
                var data = {
                    'postId': $('#post_id').val()
                }
                
                postRequest(data, postImagesUrl, token).then(response => {
                    var images = response.images;
                
                    // dropzone.options.maxFiles = dropzone.options.maxFiles - images.length;
                    for (var i = 0; i < images.length; i++) {
                        var url = window.params.url + "/" + images[i].path;
                        var mockFile = { name: images[i].path, size: images[i].size };
                        dropzone.displayExistingFile(mockFile, url);
                    }
                    // coutFiles = images.length;
                    // console.log(coutFiles);
                    // $('#count').val(coutFiles);
                ...
                this.on("success", function(file, response) {
                    ...
                    // console.log(uploadedImages);
                    // $('#count').val(coutFiles);
                    // dropzone.options.maxFiles = dropzone.options.maxFiles - coutFiles
                });
                this.on("removedfile", function(file) {
                    let name = file.name;
                    deletePostImage(file.name)
                    
                    for (let i = 0; i < uploadedImages.length; i++) 
                    { 
                        if (uploadedImages[i].image === extractLeftPart(name) + ".webp") {
    ...
    function extractLeftPart(input) {
    // ใช้ split(".") เพื่อแยกข้อความที่อยู่ด้านซ้ายและด้านขวาของจุด
    let parts = input.split(".");
    
    // ตรวจสอบว่ามีอย่างน้อย 1 ส่วนหรือไม่
    if (parts.length > 1) {
    // ใช้ join(".") เพื่อรวมข้อความทั้งหมดที่อยู่ด้านซ้ายของจุด
    let leftPart = parts.slice(0, -1).join(".");
    return leftPart;
    } else {
    // ถ้าไม่มีจุด, คืนข้อความเดิม
    return input;
    }
    }
...
function deletePostImage(imageFile)
{
    var token = window.params.token
    var deletePostImageUrl = window.params.deletePostImageRoute
    ...
    postRequest(data, deletePostImageUrl, token).then(response => {
