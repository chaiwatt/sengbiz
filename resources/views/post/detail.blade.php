...
@section('keywords',
'ประกาศฟรี,เซ้งกิจการ,ขายกิจการ,ขายคอนโด,ขายบ้านเดี่ยว,ขายทาว์นโฮม,ขายตึกแถว/อาคารพาณิชย์,ขายที่ดิน,ขายแฟรนไชส์,ให้เช่าที่,ฝากขาย,นายหน้าอสังหาริมทรัพย์')
@section('content')
                                ...
                                <div class="bg-white col-lg-5 col-md-5 col-xl-4 position-relative">
                                    <div class="card-image-hover dark-overlay h-100 overflow-hidden position-relative">
                                        ...
                                        <a href="{{route('view',['slug' => $featurePost->slug])}}"
                                            class="stretched-link" aria-label="{{$featurePost->title}}">
                                            ...
                                            <img src="{{ asset('assets/images/no-image/no-image-' . rand(1, 2) . '.webp') }}"
                                                ...
                                                style="max-height: 200px !important" alt="{{$featurePost->title}}"
                                                decoding="async">
                                            @endif
                                        </a>
                                        <!-- end /. image -->
