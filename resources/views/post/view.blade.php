                ...
                <div class="row gx-2 zoom-gallery">
                    <div class="col-md-8">
                        <a class="d-block position-relative" href="{{ asset($image1) }}"
                            ...
                            <div class="position-absolute bottom-0 end-0 mb-3 me-3">
                                <span
                                    class="align-items-center btn btn-light btn-sm d-flex d-md-none fw-semibold gap-2">
                    ...
                    <div class="col-md-4 d-none d-md-inline-block">
                        ...
                        <a class="d-block position-relative" href="{{ asset($image3) }}"
                            ...
                            <div class="position-absolute bottom-0 end-0 mb-3 me-3">
                                <span
                                    class="align-items-center btn btn-light btn-sm d-md-inline-flex d-none fw-semibold gap-2">
                                    <i class="fa-solid fa-expand"></i>
                                    <span> ดูรูปทั้งหมด</span>
                                </span>
                            </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="g-0 row">
                                    <div class="bg-white col-lg-5 col-md-5 col-xl-4 position-relative">
                                        <div
                                            class="card-image-hover dark-overlay h-100 overflow-hidden position-relative">
                                            <!-- start image -->
                                            {{-- --}}

                                            @if ($post->postImages->first() && $post->postImages->first()->path !==
                                            null)
                                            <img src="{{ asset($post->postImages->first()->path) }}"
                                                alt="{{$post->title}}" class="h-100 w-100 object-fit-cover"
                                    ...
                                    <div class="col-lg-7 col-md-7 col-xl-8 p-3 p-lg-4 p-md-3 p-sm-4">
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <div class="d-flex flex-wrap gap-3 mt-auto z-1">
                                                ...
                                                <a href="#" class="d-flex gap-2 align-items-center fs-13 fw-semibold">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="#9b9b9b" class="bi bi-currency-dollar"
                                                        viewBox="0 0 16 16">
                                                        <path
