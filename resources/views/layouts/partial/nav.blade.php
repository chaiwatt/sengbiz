    ...
    <div class="container">
        ...
        <div class="d-flex order-lg-2">
            ...
            {{-- <a href="#"
                ...
                <span
                    class="align-items-center bg-primary d-flex end-0 fs-11 justify-content-center nav-count position-absolute rounded-circle text-white">{{$post->contactMessages->count()}}</span>
            </a> --}}
