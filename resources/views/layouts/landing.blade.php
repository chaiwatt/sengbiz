            ...
            <div class="container">
                ...
                <div class="d-flex order-lg-2">
                    ...
                    <a href="add-listing.html"
                        class="btn btn-primary d-none d-sm-flex fw-medium gap-2 hstack rounded-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle material-ripple" href="#" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="typcn typcn-weather-stormy top-menu-icon"></i>รับฝากขาย
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="dashboard/dashboard.html">แฟรนไชส์ก๋วยเตี๋ยว</a></li>
                                <li><a class="dropdown-item" href="dashboard/bookings.html">แฟรนไชส์กาแฟ</a></li>
            ...
            <div class="row g-3 g-xl-0">
                ...
                <div class="col-md-9 col-lg-5 col-xl-6">
                    <div class="search-select-input has-icon has-icon-y position-relative">
                        ...
                        <!-- icon -->
                        <svg id="mySVG" class="form-icon-end position-absolute top-50 bi bi-crosshair"
                            xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#9b9b9b"
                            viewBox="0 0 16 16">
                            <path
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div
                                            ...
                                            <span class="fw-medium text-primary"><span
                                                    class="fs-6 fw-semibold me-1">(4.5)</span>เข้าดู 2,391</span>
                                        ...
                                        <p class="mt-3 fs-15">It is a long established fact that a reader will be
                        ...
                        <div class="card-body p-0">
                            <div class="g-0 row">
                                <div class="bg-white col-lg-5 col-md-5 col-xl-4 position-relative">
                                    <div class="card-image-hover dark-overlay h-100 overflow-hidden position-relative">
                                        <!-- start image -->
                                        <img src="assets/images/place/02.jpg" alt=""
                                            class="h-100 w-100 object-fit-cover">
                                        <!-- end /. image -->
                                        <div
                                            class="bg-blur card-badge d-inline-block position-absolute start-0 text-white z-2">
                                ...
                                <div class="col-lg-7 col-md-7 col-xl-8 p-3 p-lg-4 p-md-3 p-sm-4">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div
                                            ...
                                            <!-- start rating counter text -->
                                            <span class="fw-medium text-primary"><span
                                                    class="fs-6 fw-semibold me-1">(4.5)</span>2,391 reviews</span>
                                            <!-- end /. rating counter text -->
                                        </div>
                                        <!-- start card title -->
                                        <h4 class="fs-18 fw-semibold mb-0">
                                        ...
                                        <!-- end /. card title -->
                                        <!-- start card description -->
                                        <p class="mt-3 fs-15">There are many variations of passages of Lorem Ipsum
                        ...
                        <div class="card-body p-0">
                            <div class="g-0 row">
                                <div class="bg-white col-lg-5 col-md-5 col-xl-4 position-relative">
                                    <div class="card-image-hover dark-overlay h-100 overflow-hidden position-relative">
                                        <!-- start image -->
                                        <img src="assets/images/place/03.jpg" alt=""
                                            class="h-100 w-100 object-fit-cover">
                                        <!-- end /. image -->
                                        <div
                                            class="bg-blur card-badge d-inline-block position-absolute start-0 text-white z-2">
                                ...
                                <div class="col-lg-7 col-md-7 col-xl-8 p-3 p-lg-4 p-md-3 p-sm-4">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <!-- end /. card title -->
                                        <!-- start card description -->
                                        <p class="mt-3 fs-15">All the Lorem Ipsum generators on the Internet tend to
                        ...
                        <div class="card-body p-0">
                            <div class="g-0 row">
                                <div class="bg-white col-lg-5 col-md-5 col-xl-4 position-relative">
                                    <div class="card-image-hover dark-overlay h-100 overflow-hidden position-relative">
                                        <!-- start image -->
                                        <img src="assets/images/place/04.jpg" alt=""
                                            class="h-100 w-100 object-fit-cover">
                                        <!-- end /. image -->
                                        <div
                                            class="bg-blur card-badge d-inline-block position-absolute start-0 text-white z-2">
                                ...
                                <div class="col-lg-7 col-md-7 col-xl-8 p-3 p-lg-4 p-md-3 p-sm-4">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <!-- end /. card title -->
                                        <!-- start card description -->
                                        <p class="mt-3 fs-15">It was popularised in the 1960s with the release of
                        ...
                        <div class="card-body p-0">
                            <div class="g-0 row">
                                <div class="bg-white col-lg-5 col-md-5 col-xl-4 position-relative">
                                    <div class="card-image-hover dark-overlay h-100 overflow-hidden position-relative">
                                        <!-- start image -->
                                        <img src="assets/images/place/05.jpg" alt=""
                                            class="h-100 w-100 object-fit-cover">
                                        <!-- end /. image -->
                                        <div
                                            class="bg-blur card-badge d-inline-block position-absolute start-0 text-white z-2">
                        ...
                        <div class="card-body p-0">
                            <div class="g-0 row">
                                <div class="bg-white col-lg-5 col-md-5 col-xl-4 position-relative">
                                    <div class="card-image-hover dark-overlay h-100 overflow-hidden position-relative">
                                        <!-- start image -->
                                        <img src="assets/images/place/06.jpg" alt=""
                                            class="h-100 w-100 object-fit-cover">
                                        <!-- end /. image -->
                                        <div
                                            class="bg-blur card-badge d-inline-block position-absolute start-0 text-white z-2">
                                ...
                                <div class="col-lg-7 col-md-7 col-xl-8 p-3 p-lg-4 p-md-3 p-sm-4">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <!-- end /. card title -->
                                        <!-- start card description -->
                                        <p class="mt-3">The first line of Lorem Ipsum, "Lorem ipsum dolor sit amet..",
